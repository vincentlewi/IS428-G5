...
export default function Dashboard({setSessionStarted}) {  
  // Recommended houses
  ...
  return (
    <>
      ...
      >
        ...
        <Button
          className='absolute right-0 top-16 mt-2 mr-2 transition-all duration-300 ease-in-out hover:scale-105'
